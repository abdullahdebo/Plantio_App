...
class _ScanPageState extends State<ScanPage> {
  ...
  Future processImage() async {
    ...
    if (imageURl != 'NONE') {
      ...
      await predictImage('https://m.media-amazon.com/images/I/61HCpPU1P7L._AC_UF1000,1000_QL80_.jpg').then((listTag) {
  ...
  Future<List<dynamic>> predictImage(String imageUrl) async {
    var headers = {
      'Authorization': 'Basic YWNjXzRiZDY3MzFmNDAyYjViODpmZjEwM2M5Y2U1Yzg4YWY3NWY2YjljNDQ2ZWFkM2MwMQ=='
    };
    var dio = Dio();
    ...
    if (response.statusCode == 200) {
      ...
      tags.sort((a, b) => (b['confidence'] as num).compareTo(a['confidence'] as num));
      // Extract the top 3 tags with their confidence and "en" tag
